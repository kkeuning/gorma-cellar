...
func (mt *Account) Validate() (err error) {
	...
	if mt.Href == "" {
		err = goa.StackErrors(err, goa.MissingAttributeError(`response`, "href"))
	}
	if mt.Name == "" {
		err = goa.StackErrors(err, goa.MissingAttributeError(`response`, "name"))
	}

	if mt.CreatedBy != nil {
		if err2 := goa.ValidateFormat(goa.FormatEmail, *mt.CreatedBy); err2 != nil {
			err = goa.StackErrors(err, goa.InvalidFormatError(`response.created_by`, *mt.CreatedBy, goa.FormatEmail, err2))
		}
	}
	return
}
...
func (mt *Bottle) Validate() (err error) {
	...
	if mt.Vineyard == "" {
		err = goa.StackErrors(err, goa.MissingAttributeError(`response`, "vineyard"))
	}
	if mt.Varietal == "" {
		err = goa.StackErrors(err, goa.MissingAttributeError(`response`, "varietal"))
	}

	if mt.Account != nil {

		if mt.Account.Href == "" {
			err = goa.StackErrors(err, goa.MissingAttributeError(`response.account`, "href"))
		}
		if mt.Account.Name == "" {
			err = goa.StackErrors(err, goa.MissingAttributeError(`response.account`, "name"))
		}

		if mt.Account.CreatedBy != nil {
			if err2 := goa.ValidateFormat(goa.FormatEmail, *mt.Account.CreatedBy); err2 != nil {
				err = goa.StackErrors(err, goa.InvalidFormatError(`response.account.created_by`, *mt.Account.CreatedBy, goa.FormatEmail, err2))
			}
		}
	}
	if mt.Links != nil {
		if mt.Links.Account != nil {
			...
			if mt.Links.Account.Href == "" {
				err = goa.StackErrors(err, goa.MissingAttributeError(`response.links.account`, "href"))
			}

		}
	}
	if len(mt.Name) < 2 {
		err = goa.StackErrors(err, goa.InvalidLengthError(`response.name`, mt.Name, len(mt.Name), 2, true))
	}
	if mt.Rating != nil {
		if *mt.Rating < 1 {
	...
	if len(mt.Varietal) < 4 {
		err = goa.StackErrors(err, goa.InvalidLengthError(`response.varietal`, mt.Varietal, len(mt.Varietal), 4, true))
	}
	if len(mt.Vineyard) < 2 {
		err = goa.StackErrors(err, goa.InvalidLengthError(`response.vineyard`, mt.Vineyard, len(mt.Vineyard), 2, true))
	}
	if mt.Vintage < 1900 {
		err = goa.StackErrors(err, goa.InvalidRangeError(`response.vintage`, mt.Vintage, 1900, true))
	}
	if mt.Vintage > 2020 {
		err = goa.StackErrors(err, goa.InvalidRangeError(`response.vintage`, mt.Vintage, 2020, false))
	}
	return
}
...
func (mt *BottleFull) Validate() (err error) {
	...
	if mt.Color == "" {
		err = goa.StackErrors(err, goa.MissingAttributeError(`response`, "color"))
	}
	...
	if !(mt.Color == "red" || mt.Color == "white" || mt.Color == "rose" || mt.Color == "yellow" || mt.Color == "sparkling") {
		err = goa.StackErrors(err, goa.InvalidEnumValueError(`response.color`, mt.Color, []interface{}{"red", "white", "rose", "yellow", "sparkling"}))
	}
	if mt.Country != nil {
		if len(*mt.Country) < 2 {
			err = goa.StackErrors(err, goa.InvalidLengthError(`response.country`, *mt.Country, len(*mt.Country), 2, true))
		}
	}
	if mt.Links != nil {
		if mt.Links.Account != nil {
	...
	if mt.Review != nil {
		if len(*mt.Review) < 3 {
			err = goa.StackErrors(err, goa.InvalidLengthError(`response.review`, *mt.Review, len(*mt.Review), 3, true))
		}
	}
	if mt.Review != nil {
		if len(*mt.Review) > 300 {
			err = goa.StackErrors(err, goa.InvalidLengthError(`response.review`, *mt.Review, len(*mt.Review), 300, false))
		}
	}
	if mt.Sweetness != nil {
		if *mt.Sweetness < 1 {
			err = goa.StackErrors(err, goa.InvalidRangeError(`response.sweetness`, *mt.Sweetness, 1, true))
		}
	}
	if mt.Sweetness != nil {
		if *mt.Sweetness > 5 {
			err = goa.StackErrors(err, goa.InvalidRangeError(`response.sweetness`, *mt.Sweetness, 5, false))
		}
	}
	if len(mt.Varietal) < 4 {
		err = goa.StackErrors(err, goa.InvalidLengthError(`response.varietal`, mt.Varietal, len(mt.Varietal), 4, true))
...
func (mt BottleCollection) Validate() (err error) {
	for _, e := range mt {
		...
		if e.Account != nil {
			...
			if e.Account.CreatedBy != nil {
				if err2 := goa.ValidateFormat(goa.FormatEmail, *e.Account.CreatedBy); err2 != nil {
					err = goa.StackErrors(err, goa.InvalidFormatError(`response[*].account.created_by`, *e.Account.CreatedBy, goa.FormatEmail, err2))
				}
			}
		}
		if e.Links != nil {
		...
		if len(e.Name) < 2 {
			err = goa.StackErrors(err, goa.InvalidLengthError(`response[*].name`, e.Name, len(e.Name), 2, true))
		}
		if e.Rating != nil {
			if *e.Rating < 1 {
		...
		if len(e.Varietal) < 4 {
			err = goa.StackErrors(err, goa.InvalidLengthError(`response[*].varietal`, e.Varietal, len(e.Varietal), 4, true))
		}
		if len(e.Vineyard) < 2 {
			err = goa.StackErrors(err, goa.InvalidLengthError(`response[*].vineyard`, e.Vineyard, len(e.Vineyard), 2, true))
		}
		if e.Vintage < 1900 {
			err = goa.StackErrors(err, goa.InvalidRangeError(`response[*].vintage`, e.Vintage, 1900, true))
		}
		if e.Vintage > 2020 {
			err = goa.StackErrors(err, goa.InvalidRangeError(`response[*].vintage`, e.Vintage, 2020, false))
		}
	}
	return
}
